...
ADMINS = [
    ('Daniel Kim', 'pucker_bibs.0p@icloud.com'),
]
...
EMAIL_HOST_USER = 'bunnycast.fastapi@gmail.com'
EMAIL_HOST_PASSWORD = 'Zilzu100$**'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER

# WELCOME_EMAIL_SENDER = 'pucker_bibs.0p@icloud.com'
